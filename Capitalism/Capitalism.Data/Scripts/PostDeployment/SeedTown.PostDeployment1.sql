...
BEGIN
	...
	INSERT INTO [Towns] ([Id], [Name], [Population], [PollutionLevel], [ModifiedDate], [CreatedDate]) VALUES (@TownId, 'Capitalville', 0, 0, GETDATE(), GETDATE())
	...
	INSERT INTO [TownBuildings] ([Id], [TownId], [XCoordinate], [YCoordinate], [Name], [BuildingType], [IsForSale], [Price], [ModifiedDate], [CreatedDate]) VALUES (NEWID(), @TownId, 2, 0, 'For Sale', 'EmptyLand', 1, 10, GETDATE(), GETDATE())
